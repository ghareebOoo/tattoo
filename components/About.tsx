...
export default function About() {
  return (
    <motion.div variants={variants} initial="hidden" whileInView={"show"} className='p-5 overflow-hidden lg:h-[600px] flex flex-col lg:flex-row items-center lg:gap-10'>
      <motion.div initial={{x: -100 , opacity: 0}} whileInView={{x: 0 , opacity: 1}} transition={{duration: 1 }} viewport={{once: false}} className='lg:-tracking-wider leading-none font-rozha text-[300px] lg:text-[700px] bg-[url("/src/about/image.png")] bg-clip-text text-transparent bg-center bg-no-repeat'>01</motion.div>
